...
public class CourseCodeContorller extends BaseServlet {
    ...
    //查询课程邀请码
    public void queryCourseCode(HttpServletRequest request, HttpServletResponse response) throws IOException {
        Map<String, Object> map = new HashMap<>();
        if (request.getParameter("userId") != null && !Objects.equals(request.getParameter("userId"), "")) {
            map.put("userId", Integer.parseInt(request.getParameter("userId")));
        }
        if (request.getParameter("courseId") != null && !Objects.equals(request.getParameter("courseId"), "")) {
    ...
    public void deleteCourseCode(HttpServletRequest request, HttpServletResponse response) throws IOException {
        Map<String, Object> map = new HashMap<>();
    ...
    public void insertCourseCode(HttpServletRequest request, HttpServletResponse response) throws IOException {
