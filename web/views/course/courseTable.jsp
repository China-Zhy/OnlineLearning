...
<head>
    ...
    <link rel="icon" href="/layuiadmin/resource/image/courseTable.png">
            ...
            <div class="layui-card">
                    ...
                    <div class="layui-form-item">
                        <div class="layui-inline">
                            ...
                            <div class="layui-input-block">
                                <input type="number" name="id" id="id" placeholder="请输入课程编号..." autocomplete="off" class="layui-input" style="letter-spacing: 1px;">
                            </div>
                        </div>

                        <div class="layui-inline">
                            <label class="layui-form-label" style="font-weight: bold;">课程名</label>
                            <div class="layui-input-block">
                        ...
                        <div class="layui-inline">
                            <label class="layui-form-label" style="font-weight: bold;">课程类型</label>
                            <div class="layui-input-block">
                        ...
                        <div class="layui-inline">
                            <label class="layui-form-label" style="font-weight: bold;">课程状态</label>
                            <div class="layui-input-block">
                                <select name="state" id="state">
                                    <option value="0">全部状态</option>
                                    <option value="1">正常</option>
                                    <option value="2">折扣</option>
                                    <option value="3">限免</option>
                                </select>
                            </div>
                        </div>
                ...
                <div class="layui-card-body">
                    ...
                    <script type="text/html" id="buttonTpl">
                        ...
                        {{#  } else if(d.state == 2){ }}
                        <button class="layui-btn layui-btn-xs">折扣</button>
                        {{#  } else { }}
                        <button class="layui-btn layui-btn-danger layui-btn-xs">限免</button>
                        {{#  } }}
                    </script>
    ...
    layui.config({
        ...
        table.render({
            ...
            cols: [[
                ...
                {field: 'id', width: 120, title: '课程编号', sort: true, fixed: 'left', align: "center"},
                {field: 'name', width: 150, title: '课程名称', align: "center"},
                {field: 'courseType', width: 120, title: '课程类型', sort: true, align: "center"},
                {field: 'image', width: 100, title: '课程图片', templet: "#imageTpl", align: "center"},
                {field: 'info', width: 170, title: '课程描述', align: "center"},
                {field: 'score', width: 130, title: '课程积分', sort: true, align: "center"},
                {field: 'state', width: 130, title: '课程状态', align: "center", sort: true, templet: "#buttonTpl"},
                {field: 'userId', width: 130, title: '创建用户', align: "center"},
        ...
        // 使用Ajax异步加载表格顶部form表单中的courseType下拉菜单
        ...
        table.on('tool(OnlineLearning)', function (obj) {
            ...
            if (obj.event === 'detail') {
                ...
                layer.open({
                    type: 2,
                    title: '编辑课程数据',
                    content: '/views/course/courseEdit.jsp',
                    maxmin: true,
                    area: ['700px', '550px'],
                    btn: ['确定', '取消'],
        ...
        let active = {
            ...
            add: function () { // 新增数据(改这里)
                layer.open({
                    type: 2,
                    title: '添加课程数据',
                    content: '/views/course/courseInsert.jsp',
                    maxmin: true,
                    area: ['700px', '550px'],
                    btn: ['确定', '取消'],
                    success: function (layero, index) {
                    ...
                    yes: function (index, layero) {
                        ...
                        iframeWindow.layui.form.on('submit(' + submitID + ')', function (data) {
                            ...
                            $.ajax({
                                type: 'post',
                                url: '/course?method=insertCourse',
                                data: data.field,
                                dataType: 'json',
                                success: function (data) {
                                    if (data.result === 1) {
